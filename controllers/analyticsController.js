  ...
  try {
    ...
    if (smartLink.platformClickStats && typeof smartLink.platformClickStats === 'object') {
      ...
      if (smartLink.platformClickStats instanceof Map) {
        ...
        for (const platformNameKey in rawStats) {
          if (Object.prototype.hasOwnProperty.call(rawStats, platformNameKey)) {
            const clicks = rawStats[platformNameKey];
            console.log(`🔍 Platform found: "${platformNameKey}" with ${clicks} clicks`);
